                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-wrap gap-4 mb-8">
                        <button
                            ...
                            className={`px-6 py-2 rounded-lg font-medium transition-all ${activeTab === 'add'
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-lg font-medium transition-all ${activeTab === 'payments'
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-lg font-medium transition-all ${activeTab === 'reviews'
