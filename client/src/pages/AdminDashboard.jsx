        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-900">
                <div className="text-center">
                    ...
                    <button onClick={() => navigate('/')} className="mt-6 px-6 py-2 bg-blue-600 text-white rounded">Go Home</button>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <div className="pt-8 px-4 md:px-8 pb-8 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    <h1 className="text-2xl md:text-3xl font-bold text-green-600">Admin Dashboard</h1>
                </div>
                ...
                {activeTab === 'manage' ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                        ...
                        <div className="mb-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <h3 className="text-sm font-bold text-blue-600 mb-3 uppercase tracking-wider">🚀 Auto-Fill via ISBN (Optional)</h3>
                            <div className="flex flex-col sm:flex-row gap-4">
                                <input
                                    ...
                                    className="flex-1 bg-white border border-gray-300 rounded p-2 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none"
                                />
                                <button
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="col-span-1">
                                <label className="block text-sm font-medium mb-1 text-gray-700">ISBN (Auto-filled or Empty)</label>
                                <input
                                    type="text"
                                    name="isbn"
                                    value={isbnInput} // Should we sync this? Or separate? Let's use separate field.
                                    disabled
                                    className="w-full bg-gray-50 border border-gray-300 rounded p-2 text-gray-500 cursor-not-allowed"
                            ...
                            <div className="col-span-1">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-white border border-gray-300 rounded p-2 text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:outline-none"
                            ...
                            {/* Publisher */}
                            <div className="col-span-1">
                                <label className="block text-sm font-medium mb-1 text-gray-700">Publisher</label>
                                <input
                                    type="text"
                                    name="publisher"
                            ...
                            <div className="col-span-2">
                                <label className="block text-sm font-medium mb-1 text-gray-700">About Author</label>
                                <textarea
                                    name="authorBio"
                            ...
                            {/* Details Row */}
                            <div className="col-span-1">
                                <label className="block text-sm font-medium mb-1 text-gray-700">Pages</label>
                                <input
                                    type="number"
                                    name="pages"
                            ...
                            {/* E-Book Fields Row */}
                            <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                                {/* PDF File Upload */}
                                <div className="col-span-2">
                                    <label className="block text-sm font-bold mb-1 text-blue-600">Upload PDF E-Book</label>
                            ...
                            <div className="col-span-2 mt-4">
                                {loading && uploadProgress > 0 && (
                                    <div className="w-full bg-gray-200 rounded-full h-2.5 mb-2">
                                        ...
                                        <p className="text-xs text-green-600 text-center mt-1">Uploading: {uploadProgress}%</p>
                                    </div>
                                )}
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-3 rounded shadow-md transform transition hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed"
                                >
